import sbt.Keys.{baseDirectory, dependencyOverrides}
import sbt.Runtime

ThisBuild / organization := "com.mycompany"

// Scala 2.13 options from https://nathankleyn.com/2019/05/13/recommended-scalac-flags-for-2-13/
